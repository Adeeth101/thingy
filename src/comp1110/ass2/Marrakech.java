...
public class Marrakech {
    ...
    public static boolean isRugValid(String gameString, String rug) {
        char[] rugC = rug.toCharArray();
        if (rugC.length != 7) {
            return false;
        }
        int c = 0;
        GameState game = new GameState(gameString);
        ArrayList<Player> players = game.getPlayers();
        for (Player player : players) {
            if (player.getColour() == rugC[0]) {
                c++;
            }
        }
        if (c != 1) {
        ...
        for (int i = 3; i < rugC.length; i++) {
            for (int element : arr) {
                if (element == Character.getNumericValue(rugC[i])) {
                    x++;
                }
            }
        }
        ...
        BoardOther boardOther = new BoardOther(gameString);
        Rug rugS = new Rug(rug);
        RugSimple rugSimple = new RugSimple(rugS);
        boolean check = boardOther.isRugOnBoard(rugSimple);
        return !check;
    }

    /*
    Pc03015iPy03015iPp03015iPr03015iA31NB
    ...
    n00 n00 n00 n00 n00 n00 n00
    n00 n00 n00 n00 n00 n00 n00
    Pc03015iPy03015iPp03015iPr03015iA31NBn00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00n00
    ...
    public static boolean isGameOver(String currentGame) {
        ...
        for (int num =0; num<4; num++) {
            ...
            System.out.println("getRemainRugs(): "+ gamestate.getPlayers().get(num).getRemainRugs());
            System.out.println("Player.isInGame: "+ Player.isInGame());
            if (Player.isInGame() && gamestate.getPlayers().get(num).getRemainRugs()>0){
                return false;
            }else {accumulation++;}
        }
        System.out.println("accumulation "+accumulation);
        if (accumulation >= 3) return true;
        else return false;
    }
    ...
    public static boolean isPlacementValid(String gameState, String rug) {
        ...
        BoardOther boardOther = new BoardOther(gameState);
        Rug r = new Rug(rug);
        return boardOther.isRugAllowed(r, assam);

        /*
        n00 n00 y01 n00 n00 n00 n00
        n00 n00 y01 n00 n00 n00 n00
        n00 n00 n00 p00 n00 n00 n00
        n00 n00 n00 p00 n00 n00 n00
        n00 n00 n00 n00 n00 n00 n00
        n00 n00 n00 n00 n00 n00 n00
        n00 n00 n00 n00 n00 n00 n00
    ...
    public static int getPaymentAmount(String gameString) {
        ...
        return boardOther.paymentAmount(coords);
    }
    ...
    public static char getWinner(String gameState) {
        if (!isGameOver(gameState)){
            ...
            System.out.println(getPaymentAmount(gameState));
        }

        GameState state = new GameState(gameState);
        System.out.println(state);

        String playerState = gameState.substring(0,32);
    ...
    public static String makePlacement(String currentGame, String rug) {
        GameState gameState = new GameState(currentGame);
        Rug r = new Rug(rug);
        gameState.setCurrentColour(r.getColour());
        gameState.placeRug(r);
